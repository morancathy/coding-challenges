// Sequence 2.3 Superstar Coding Challenges
//Take it Easy
// 1) Make Array
const rainbowArray = ['red', 'orange', 'yellow', 'green', 'blue', 'indigo', 'violet'];

// 2) Access item in Array
...
// 4) Access item in Object
console.log(`${cathy.hobby} \n`);

// Crazy object
// Accessing items in crazy object
const crazyObject = {
  taco: [{meat: 'steak',
...
//I am trying to print thee single movie OBJECT that contains the actor who starred in least # of files.
// Expecing: { "title" : "On Her Majesty's Secret Service", "year" : 1969, "actor" : "George Lazenby", "gross" : "$505,899,782" }
